...
## Masaüstü Kurulum Dosyaları

| Platform | Dosya |
|---|---|
| macOS | [Sinav-Programi-Robotu-macOS.dmg](https://github.com/alparslanguvenc/sinav-programi-robotu/releases/latest/download/Sinav-Programi-Robotu-macOS.dmg) |
| Windows | [Sinav-Programi-Robotu-Windows-Setup.exe](https://github.com/alparslanguvenc/sinav-programi-robotu/releases/latest/download/Sinav-Programi-Robotu-Windows-Setup.exe) |

> En güncel masaüstü sürümünü doğrudan bu iki dosyadan indirebilirsiniz. Eğer release henüz yeni oluşturulduysa GitHub dosyaları görünene kadar birkaç dakika sürebilir.
...
- Web sürümünde sınav programları ve kayıtlar **tarayıcınızın `localStorage`'ına** yazılır.
- Masaüstü sürümünde kayıtlar ayrıca **işletim sisteminin uygulama veri klasörüne** yedeklenir; yine yalnızca bu bilgisayarda kalır.
...
```bash
npm run build:icon     # İkon setini yeniden üret
